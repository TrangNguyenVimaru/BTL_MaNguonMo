...
<?php  if (is_front_page() && get_header_image() ) : ?>
	...
	<div class="grid absolute">
		<div class="col-4-12 intro-header">
			...
			<a class="button-a" href="#"> <?php echo esc_html( get_theme_mod( 'real_estate_lite_header_button_a' ) ); ?> </a>
			<?php } if ( get_theme_mod( 'real_estate_lite_header_button_b_url' ) ) { ?>
			<a class="button-b" href="#"> <?php echo esc_html( get_theme_mod( 'real_estate_lite_header_button_b' ) ); ?></a>
			<?php } ?>
		</div>
	</div>
	<?php } ?>
