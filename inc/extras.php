 ...
 * @return array
 */
function real_estate_lite_body_classes( $classes ) {
...
add_filter( 'body_class', 'real_estate_lite_body_classes' );

//Page Titles
function real_estate_lite_page_title() {
...
class Real_Estate_CSS_Menu_Walker extends Walker {
